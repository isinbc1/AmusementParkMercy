...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если БаллыКСписанию <> 0 Тогда
		...
		Если БаллыКСписанию > СуммаПродажи Тогда
			...
			Сообщение.Текст = "Количество баллов не должно превышать сумму продажи";
...
КонецЕсли;		
	...
	// Проверка клиента, если баллы не списываюстя
	...
	// Убираем "Клиент" из стандартной проверки, чтобы платформа не дублировала сообщение, мб и вовсе нужно убрать


		Элемент = ПроверяемыеРеквизиты.Найти("Клиент");
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Запрос. Текст =
	 ...
	 |		КоличествоПосещений,
	 |	ПродажаБилетовПозицииПродажи.Сумма КАК Сумма
	 |ИЗ
